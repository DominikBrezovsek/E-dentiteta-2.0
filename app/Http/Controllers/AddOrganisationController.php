...
class AddOrganisationController extends Controller
{
    ...
    public function postAddOrganisation(Request $request){
        ...
        $organisation->save();
        return redirect()->route('organisation_admin.organisations')->with('message', 'Organizacija ustvarjena!');
    }
    //Edit professor
    ...
    public function postOrganisation(Request $request, Organisation $organisationId){
        ...
        return redirect()->route('organisation_admin.organisations')->with('message', 'Podatki organizacije so bili posodobljeni!');
    }
    //All organisations
    ...
    public function deleteOrganisation(Request $request, Organisation $organisationId){
        ...
        return redirect()->route('organisation_admin.organisations')->with('message', 'Organizacija je bila izbrisana!');
    }
}
