...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <x-form :existingData="$existingData" submitRouteName="organisation.profile" backRouteName="organisation.profile"
                ...
                <x-input type="datetime" name="date" displayedName="Datum članstva" readonly="true" :value="$existingData->created_at != null ? $existingData->created_at : 'Bedak'" />
